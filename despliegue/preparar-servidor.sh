...
echo "  3. Desplegar el sitio con publicar.sh desde la máquina de desarrollo"
echo "  4. Cuando el dominio resuelva, correr dominio.sh: escribe la"
echo "     configuración de nginx y saca el certificado"
